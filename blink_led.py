...
led = LED(17) # Cria um objeto 'led' associado ao pino GPIO 17, configurando esse pino como SAÍDA
...
while True:       # Inicia um laço de repetição infinito
	...
	sleep(1)      # Pausa novamente por 1 segundo antes de voltar ao início
